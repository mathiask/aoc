...
NB. 1.1
NB. ---
>./ > +/ @: (". every) each (<;._2 LF chopstring fread '/Users/mathias/u/j/aoc-2022-1.txt')
NB. => 72602

NB. ... or ...
>./ > +/ @: (". every) each (a: cut <;._2 fread '/Users/mathias/u/j/aoc-2022-1.txt')


NB. 1.2
NB. ---
+/ 3 {. \:~ > +/ @: (". every) each (<;._2 LF chopstring fread '/Users/mathias/u/j/aoc-2022-1.txt')
NB. => 207410

NB. ... or ...
+/ 3 {. \:~ > +/ @: (". every) each (a: cut <;._2 fread '/Users/mathias/u/j/aoc-2022-1.txt')

NB. ----------------------------------------------------------------------

NB. 2.1
NB. ---_
+/ > ([: +/ (('ABC' i. {.) ([: >: ] + (3 3 $ 3 6 0 0 3 6 6 0 3) {~ [: < ,) ('XYZ' i. {:))) each (;&;: each LF cut fread '/Users/mathias/u/j/aoc-2022-2.txt')
NB. => 13446

NB. 2.2
NB. ---_
+/;(('ABC' i. {.) ([: >: ]+((3 3 $ 3 6 0 0 3 6 6 0 3){~[) i. ])(3 * 'XYZ' i. {:)) each ;&;:each LF cut fread'/Users/mathias/u/j/aoc-2022-2.txt'
NB. => 13509
...
p3 =. LF cut fread'/Users/mathias/u/j/aoc-2022-3.txt'
+/ sP3 every p3
NB. => 7742
...
NB. 4.1
NB. ---
p4 =. LF cut fread'/Users/mathias/u/j/aoc-2022-4.txt'
s4lcont =: (<: & (0&{)) *. (>: & (1&{))
...
NB. p5 =: <;._2 fread'/Users/mathias/u/j/aoc-2022-5pre.txt'
p5 =: <;._2 fread'/Users/mathias/u/j/aoc-2022-5.txt'
p5s =: }: {. (p5 ];._2~ a: = p5)
...
NB. ==================== CONCISE SOLUTION ====================
'p q' =. ];._1 a:,<;._2 fread'/Users/mathias/u/j/aoc-2022-5.txt'
...
NB. 7.1
NB. ---
]p =. cut ;._2 fread'/Users/mathias/u/j/aoc-2022-7pre.txt'
...
NB. ---
froml =: (> _1 , [: }: [: >./\ ])"1
+/+/(froml+.(froml&.(|."1))+.(froml&.|:)+.(froml&.(|."1@:|:))) "."0;._2 fread'/Users/mathias/u/j/aoc-2022-8.txt'
NB. => 1763
...
>./>./(viewsr * (viewsr&.(|."1)) * (viewsr&.|:) * (viewsr&.(|."1@:|:))) "."0;._2 fread'/Users/mathias/u/j/aoc-2022-8.txt'
NB. => 671160
...
]p9 =. cutLF fread'/Users/mathias/u/j/aoc-2022-9.txt'
...
NB. 10.1
NB. ----
]p10 =. <;._2 fread'/Users/mathias/u/j/aoc-2022-10.txt'
...
p11 =: > a: cut <;._2 fread '/Users/mathias/u/j/aoc-2022-11.txt'
atoi =: (a.{~48+i.10) ".@(e.~#]) ]
...
n11 =: '0123456789,'&(".@(e.~#]))&.> n011 =: > a: cut <;._2 fread '/Users/mathias/u/j/aoc-2022-11.txt'
f11 =: dyad define
  k =. >./1, 2 pick x
  e =. 2 pick y
...
p12 =: >cutLF fread'/Users/mathias/u/j/aoc-2022-12.txt'
...
p18 =: ".&> LF cut fread'/Users/mathias/u/j/aoc-2022-18.txt'
((6 * #) - +/@,@(1 = [: +/"1 |@-"1/~)) p18
NB. => 4302
...
]p20 =: ".&> cutLF fread'/Users/mathias/u/j/aoc-2022-20.txt'
...
]p25 =: cutLF fread'/Users/mathias/u/j/aoc-2022-25.txt'
